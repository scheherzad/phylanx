...
#include <phylanx/execution_tree/primitives/sub_operation_lambda.hpp>
...
typedef hpx::components::component<
        phylanx::execution_tree::primitives::sub_operation_lambda>
        sub_operation_lambda_type;
HPX_REGISTER_DERIVED_COMPONENT_FACTORY(
        sub_operation_lambda_type, phylanx_sub_operation_lambda_component,
        "phylanx_primitive_component", hpx::components::factory_enabled)
HPX_DEFINE_GET_COMPONENT_TYPE(sub_operation_lambda_type::wrapped_type)

///////////////////////////////////////////////////////////////////////////////
namespace phylanx { namespace execution_tree { namespace primitives
        {
            ///////////////////////////////////////////////////////////////////////////
            std::vector<match_pattern_type> const sub_operation_lambda::match_data =
                    {
                            hpx::util::make_tuple("sub", "_1 - __2", &create<sub_operation_lambda>)
                    };

            ///////////////////////////////////////////////////////////////////////////
            sub_operation_lambda::sub_operation_lambda(
            ...
            namespace detail
            {
                ...
                protected:
                    ...
                    primitive_result_type sub0d1d(operands_type && ops) const
                    {
                        ...
                        ops[1].vector() =
                                blaze::map(ops[1].vector(),[&](double x){return ops[0].scalar()-x;});
                    ...
                    primitive_result_type sub0d2d(operands_type && ops) const
                    {
                        ...
                        ops[1].matrix() =
                                blaze::map(ops[1].matrix(), [&](double x){return ops[0].scalar()-x;});
                        return primitive_result_type(std::move(ops[1]));
                    }
                    ...
                    primitive_result_type sub1d0d(operands_type && ops) const
                    {
                        ...
                        ops[0].vector() =
                                blaze::map(ops[0].vector(), [&](double x){return x-ops[1].scalar();});
                    ...
                    primitive_result_type sub2d0d(operands_type && ops) const
                    {
                        ...
                        ops[0].matrix() =
                                blaze::map(ops[0].matrix(), [&](double x){return x-ops[1].scalar();});
                        return primitive_result_type(std::move(ops[0]));
                    }
            ...
            hpx::future<primitive_result_type> sub_operation_lambda::eval(
                    std::vector<primitive_argument_type> const& args) const
            {
                if (operands_.empty())
                {
